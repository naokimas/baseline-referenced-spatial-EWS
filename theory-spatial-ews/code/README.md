...
The scripts behind Fig. 1 of the manuscript. **The full documentation of this repository — how to
run the two stages, what is simulated, which line of code implements which equation of the
manuscript, the networks, and the reproducibility of the noise — is in the
...
| `common/sde_simulator.py` | The Euler–Maruyama integrator (numba-JIT, CSR sparse). Every state in `data/equilibria/` came out of `solve_in_range()` here. |
